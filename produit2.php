    ...
    <div class="d-flex flex-column" id="content-wrapper">
        <div id="content">
            ...
            <section class="article-list">
                ...
                <div class="container">
                    <div class="intro">
                        <h2 class="text-center">PANTALON</h2>
                    ...
                    if ($page) {
                        echo '<a href="produit2.php"><button class="btn btn-secondary btn-sm"><<</button></a>';
//bouton pour page pred [<]
                        echo '<a href="produit2.php?page=' . $page_down . '"><button class="btn btn-secondary btn-sm"><</button></a>';
                    }

                    for ($i = 1; $i <= $pages_total; $i++) {
                        if (($i == $page + 1)) {
                            echo '<a href="produit2.php?page=' . $i . '"><button class="active btn btn-secondary btn-sm">' . $i . '</button></a>';
                        }

                        if (($i != $page + 1) && ($i <= $page + 3) && ($i >= $page - 1)) {
                            echo '<a href="produit2.php?page=' . $i . '"><button class="btn btn-secondary btn-sm">' . $i . '</button></a>';
                        }
                    }

                    if (($page + 1) != $pages_total) {
                        echo '<a href="produit2.php?page=' . $page_up . '"><button class="btn btn-secondary btn-sm">></button></a>';
                        echo '<a href="produit2.php?page=' . $pages_total . '"><button class="btn btn-secondary btn-sm">>></button></a>';
                    }
                    ...
                    <div class="row articles">
                        <?php
                        $result = mysqli_query($bdd, "SELECT * FROM produit WHERE idcat=2 ORDER BY idproduit ASC LIMIT $offset, $per_page");
                        while ($row = mysqli_fetch_array($result)) {
                            ?>
                            <div class="col-sm-6 col-md-3 item card">
                                <a href="conf_reservation.php?id=<?php echo $row["idproduit"] ?>">
                                    <img class="img-fluid" src="image_webshop/<?php echo $row["image"]; ?>"></a>
