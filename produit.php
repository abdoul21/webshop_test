    ...
    <div class="d-flex flex-column" id="content-wrapper">
        <div id="content">
            ...
            <section class="article-list">
                ...
                <div class="container">
                    <div class="intro">
                        <h2 class="text-center">TOUS LES VÊTEMENTS</h2>
                    </div>
                    ...
                    if ($page) {
                        echo '<a href="produit.php"><button class="btn btn-secondary btn-sm"><<</button></a>';
//bouton pour page pred [<]
                        echo '<a href="produit.php?page=' . $page_down . '"><button class="btn btn-secondary btn-sm"><</button></a>';
                    }

                    for ($i = 1; $i <= $pages_total; $i++) {
                        if (($i == $page + 1)) {
                            echo '<a href="produit.php?page=' . $i . '"><button class="active btn btn-secondary btn-sm">' . $i . '</button></a>';
                        }

                        if (($i != $page + 1) && ($i <= $page + 3) && ($i >= $page - 1)) {
                            echo '<a href="produit.php?page=' . $i . '"><button class="btn btn-secondary btn-sm">' . $i . '</button></a>';
                        }
                    }

                    if (($page + 1) != $pages_total) {
                        echo '<a href="produit.php?page=' . $page_up . '"><button class="btn btn-secondary btn-sm">></button></a>';
                        echo '<a href="produit.php?page=' . $pages_total . '"><button class="btn btn-secondary btn-sm">>></button></a>';
                    }
                    ...
                    <div class="row articles">
                        <?php
                        $result = mysqli_query($bdd, "SELECT * FROM produit ORDER BY idproduit ASC LIMIT $offset, $per_page");
